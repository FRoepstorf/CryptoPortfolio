...
class ErrorHandlerMiddlewareTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->errorHandlerMiddleware = new ErrorHandlerMiddleware($this->sentryClientMock, $this->scope, $this->loggerMock);
    }
    ...
    public function testProperlyHandlesThrownException(): void
    {
